...
class Yolov7_E_ELAN_MHSA(nn.Module):
    def __init__(self, inc, ouc, hidc, act=True):
        super(Yolov7_E_ELAN_MHSA, self).__init__()
    ...
    def forward(self, x):
        ...
        x6 = self.conv6(x5)
        x_concat = torch.concat([x1, x2, x4, x6], dim=1)
        x_final = self.conv7(self.attention(x_concat))
        return x_final
...
class V7DownSampling_SPD(nn.Module):
    def __init__(self, inc, ouc) -> None:
        super(V7DownSampling_SPD, self).__init__()
...
class V7DownSampling_Neck_SPD(nn.Module):
    def __init__(self, inc, ouc) -> None:
        super(V7DownSampling_Neck_SPD, self).__init__()
