...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, SCConv, Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC,
                 ...
                 Yolov7_E_ELAN, Yolov7_E_ELAN_NECK,Yolov7_E_ELAN_MHSA,
                 MHSA]:
            c1, c2 = ch[f], args[0]
            ...
            c2 = 2 * args[0] + ch[f[1]]
            args = [c1, args[0]]
        elif m is V7DownSampling_SPD:
            c1 = ch[f]
            c2 = 2 * args[0]
            args = [c1, args[0]]
        elif m is V7DownSampling_Neck_SPD:
            c1 = ch[f[0]]
            c2 = 2 * args[0] + ch[f[1]]
            args = [c1, args[0]]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='../cfg/training/yolov7-SPPFCSPC-SPD.yaml', help='model.yaml')
