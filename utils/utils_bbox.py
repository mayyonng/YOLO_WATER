...
class DecodeBox():
    ...
    def non_max_suppression(self, prediction: object, num_classes: object, input_shape: object, image_shape: object, letterbox_image: object,
                            conf_thres: object = 0.5,
                            nms_thres: object = 0.4) -> object:
        #----------------------------------------------------------#
