...
def convert_annotation(image_id):
    in_file = open('D:/rovision_project/datasets/garbage/Annotations/%s.xml' % (image_id))
    out_file = open('D:/rovision_project/datasets/garbage/labels/%s.txt' % (image_id), 'w')
...
for image_set in sets:
    ...
    image_ids = open('D:/rovision_project/datasets/sandRiver/ImageSets/%s.txt' % (image_set)).read().strip().split()
